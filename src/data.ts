...
export const QUIZ_DATA: Chapter[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 5, type: QuestionType.MULTIPLE_CHOICE, text: "من الأمثلة على التوزيع العشوائي:", options: ["الإبل", "الخيول", "الضب", "الطيور البحرية"], correctAnswer: "الطيور البحرية" },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 16, type: QuestionType.TRUE_FALSE, text: "تنوع النظام البيئي هو عدد الأنواع المختلفة والوفرة النسبية.", correctAnswer: false },
